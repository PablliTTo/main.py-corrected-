...
def attack(char_name: str, char_class: str) -> str:
    """
    Возвращает строку с описанием атаки персонажа.

    Parameters:
    - char_name (str): Имя персонажа.
    - char_class (str): Класс персонажа (warrior, mage, healer).

    Returns:
    - str: Описание атаки персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Возвращает строку с описанием блокировки атаки персонажа.
    ...
    Returns:
    - str: Описание блокировки атаки персонажа.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Возвращает строку с описанием применения специального умения персонажа.
    ...
    Returns:
    - str: Описание применения специального умения персонажа.
    """
    if char_class == 'warrior':
